        ...
        def format_drone(name: str):
            ...
            with open(os.path.join(os.path.dirname(self.filepath), f"{name}.csv"), 'w', newline='') as file:
                ...
                for i in range(num_intervals):
                    ...
                    loc = [int(l * 1000) / 1000 for l in loc]  # Frank: truncate to 3 decimal places instead of rounding - significant time loss
                    ...
                    col_rgb = [int(c * 255) for c in col[:3]]  # Frank: truncate to 3 int vals instead of rounding - significant time loss
